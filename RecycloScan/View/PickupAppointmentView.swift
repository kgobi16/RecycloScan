...
struct PickupAppointmentView: View {
    ...
    init(viewModel: PickupSchedulerVM, recyclingManager: RecyclingManager) {
                    ...
                    VStack(spacing: 24) {
                        ...
                        VStack(spacing: 16) {
                            ForEach(BinType.allCases) { binType in
                                NavigationLink(destination: BinCardView(
                                    binType: binType,
                                    viewModel: viewModel,
...
#Preview("Pickup Appointment") {
    PickupAppointmentView(viewModel: PickupSchedulerVM.sample, recyclingManager: RecyclingManager.sample)
}

#Preview("Empty Schedule") {
    PickupAppointmentView(viewModel: PickupSchedulerVM.empty, recyclingManager: RecyclingManager.sample)
}
